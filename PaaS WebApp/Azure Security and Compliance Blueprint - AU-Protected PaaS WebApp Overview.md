...
### Data in transit
Azure encrypts all communications to and from Azure datacentres by default. All transactions to Azure through the Azure management portal occur via HTTPS.
